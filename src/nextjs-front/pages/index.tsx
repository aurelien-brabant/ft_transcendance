              ...
              <ResponsiveFade useMediaQueryArg={{ query: '(min-width: 1280px)' }}  duration={800}>
                <div>
                  ...
                  <p className="py-4 text-xl">
                    ...
                    luctus, lorem non efficitur laoreet, ante arcu vehicula
                    eros, quis rutrum ligula ligula eu purus. Vestibulum tempus
                    orci ipsum, eu condimentum neque egestas non.
                  </p>
                  <p className="py-4 text-xl">
                    Nulla pulvinar luctus orci, facilisis faucibus urna tempus
                    volutpat. Sed tempor tortor orci, sit amet consequat tellus
                    mattis quis. Mauris vitae consequat mauris, non pretium
                    velit.
                  </p>
                </div>
              </ResponsiveFade>
