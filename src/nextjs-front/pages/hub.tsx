...
const Hub: NextPageWithLayout = () => {
	...
	return (
		<Fragment>
			...
			<div className="min-h-screen overflow-hidden text-white bg-fixed bg-center bg-fill grow" style={{backgroundImage: "url('/triangles.png')", height: "calc(100vh - 3.5rem)"}}>
